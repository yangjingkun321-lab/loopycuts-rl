...
with tempfile.TemporaryDirectory() as tmp:
    ...
    (
        ...
        quality_record,
        final_state,
    ) = client.finalize_quality_export(
        ref,
        output_dir,
    )
...
print(
    "PASS: FINALIZE_QUALITY_EXPORT command is emitted exactly"
)

print(
    "PASS: FINAL_RESULT and quality record parse exactly once"
)

print(
    "PASS: final STATE/ACTIONS update through existing parser"
)
